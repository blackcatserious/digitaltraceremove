const faqs = [
  ...
  },
  {
    ...
    a: 'Most cases see measurable results within 30–60 days. Complex or high-volume cases typically require 60–90 days. We provide timeline estimates after the initial confidential assessment.',
  },
  {
    q: 'Is my identity kept confidential?',
    a: 'Absolutely. A full NDA is signed before any information is shared. We never reference clients publicly, and our internal workflows are designed to protect client identity at every stage.',
  },
  {
    q: 'Can you help with content in multiple languages?',
    a: 'Yes. We operate across English, French, Spanish, Portuguese, German, and other languages. Our team covers North America, Europe, Latin America, Asia-Pacific, and Africa.',
  },
  {
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '16px' }}>
        {faqs.map((item) => (
          <article key={item.q} style={{ border: '1px solid var(--border)', borderRadius: '10px', padding: '16px' }}>
            <p style={{ color: 'var(--blue)', fontWeight: 600, margin: '0 0 8px' }}>Q</p>
