    ...
    <AppLayout>
      <Routes>
        <Route path="/" element={<HomePage
          ...
          ClientsStrip={ClientsStrip}
          PlatformsSection={PlatformsSection}
          AgenciesSection={AgenciesSection}
          ...
          FinalCTA={FinalCTA}
          MomentumTicker={MomentumTicker}
          getCaseStudiesPath={getCaseStudiesPath}
          languageLabels={languageLabels}
          navigation={navigation}
          InsightShowcase={InsightShowcase}
        />} />
