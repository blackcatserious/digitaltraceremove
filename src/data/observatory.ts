...
export const observatoryCopy: Record<Language, ObservatoryCopy> = {
  en: {
    ...
    heatmaps: {
      ...
      description:
        'Regional pods blend quant sentiment, qualitative field notes, and paid media drift so you know exactly where to reinforce brand trust next.',
      regions: [
        {
          id: 'hm1',
          region: 'North America',
          sentiment: '74',
          movement: '+8 pts week-over-week',
          priority: 'Elevate delivery transparency after LA micro-outage.',
          action: 'Launch bilingual courier update ticker and founder note in California/BC.',
        },
        {
          id: 'hm2',
          region: 'Europe',
          sentiment: '69',
          movement: '-3 pts after competitor ads',
          priority: 'Counter paid hijacks of branded keywords in Paris & Lyon.',
          action: 'Deploy new ad copy, tighten negative lists, and syndicate testimonials.',
        },
        {
          id: 'hm3',
          region: 'Latin America',
          sentiment: '81',
          movement: '+5 pts after rapid takedowns',
          priority: 'Sustain executive presence on WhatsApp community hubs.',
          action: 'Schedule weekly Portuguese Q&A and extend fraud education clips.',
        },
      ],
    },
    forecasts: {
    ...
    evidenceVault: {
      ...
      description:
        'Every observatory intervention is backed by documented evidence packs. Founders can download recent bundles or request redactions for board-ready circulation.',
      documents: [
        {
          id: 'ev1',
          name: 'Review fraud deconstruction',
          type: 'PDF dossier',
          classification: 'Confidential — founders',
          summary:
            'Annotated takedown filings, timestamped review captures, and fraud network mapping from a recent hospitality sweep.',
          cta: 'Open evidence pack',
          target: 'resources',
        },
        {
          id: 'ev2',
          name: 'Search hijack escalation log',
          type: 'Chronology workspace',
          classification: 'Internal — leadership',
          summary:
            'Minute-by-minute log of a branded keyword hijack with paid search screenshots, mitigation approvals, and recovery metrics.',
          cta: 'Review chronology',
          target: 'servicesPricing',
        },
        {
          id: 'ev3',
          name: 'Marketplace impersonation affidavits',
          type: 'Secure zip archive',
          classification: 'Legal hold',
          summary:
            'Sealed takedown affidavits, registrar correspondence, and refund reconciliation proofs from a LATAM clone network.',
          cta: 'Request secure transfer',
          target: 'contact',
        },
      ],
    },
  ...
  fr: {
    ...
    heatmaps: {
      title: 'Cartographies de sentiment',
      description:
        'Nos pods régionaux mixent score quantitatif, notes terrain et dérives paid media pour indiquer où renforcer la confiance marque en priorité.',
      regions: [
        {
          id: 'hm1',
          region: 'Amérique du Nord',
          sentiment: '74',
          movement: '+8 pts sur une semaine',
          priority: 'Renforcer la transparence logistique après micro-panne à Los Angeles.',
          action: 'Publier un ticker bilingue livraison et message fondateur pour Californie / Colombie-Britannique.',
        },
        {
          id: 'hm2',
          region: 'Europe',
          sentiment: '69',
          movement: '-3 pts suite aux ads concurrents',
          priority: 'Neutraliser les détournements SEA à Paris et Lyon.',
          action: 'Déployer nouveaux messages, resserrer les listes négatives et amplifier les témoignages clients.',
        },
        {
          id: 'hm3',
          region: 'Amérique latine',
          sentiment: '81',
          movement: '+5 pts après retraits express',
          priority: 'Entretenir la présence dirigeante sur les hubs WhatsApp.',
          action: 'Programmer un Q&A hebdomadaire portugais et diffuser des capsules pédagogie fraude.',
        },
      ],
    },
    forecasts: {
    ...
    evidenceVault: {
      ...
      description:
        'Chaque intervention observatoire s’accompagne de dossiers probants prêts à partager aux conseils. Accédez aux derniers bundles ou demandez une version expurgée pour les parties prenantes.',
      documents: [
        {
          id: 'ev1',
          name: 'Démantèlement fraude avis',
          type: 'Dossier PDF',
          classification: 'Confidentiel — fondateurs',
          summary:
            'Captures horodatées, dépôts de retrait et cartographie du réseau frauduleux issus d’une récente opération hospitality.',
          cta: 'Ouvrir le dossier',
          target: 'resources',
        },
        {
          id: 'ev2',
          name: 'Journal escalade search détourné',
          type: 'Espace chronologique',
          classification: 'Interne — direction',
          summary:
            'Compte-rendu minute par minute d’un détournement mots-clés avec captures d’enchères, validations et métriques de récupération.',
          cta: 'Consulter le journal',
          target: 'servicesPricing',
        },
        {
          id: 'ev3',
          name: 'Affidavits usurpation marketplace',
          type: 'Archive sécurisée',
          classification: 'Scellé juridique',
          summary:
            'Affidavits, échanges registraires et preuves de remboursement d’un réseau de clones LATAM prêts pour comité de risques.',
          cta: 'Demander le transfert sécurisé',
          target: 'contact',
        },
      ],
    },
  ...
  es: {
    ...
    heatmaps: {
      title: 'Mapas de sentimiento',
      description:
        'Los pods regionales cruzan puntaje cuantitativo, notas del terreno y deriva de paid media para señalar dónde reforzar la confianza de marca.',
      regions: [
        {
          id: 'hm1',
          region: 'Norteamérica',
          sentiment: '74',
          movement: '+8 pts semana contra semana',
          priority: 'Reforzar transparencia logística tras microcorte en Los Ángeles.',
          action: 'Publicar ticker bilingüe de entregas y mensaje del fundador para California y Columbia Británica.',
        },
        {
          id: 'hm2',
          region: 'Europa',
          sentiment: '69',
          movement: '-3 pts por ads de la competencia',
          priority: 'Frenar secuestros de keywords de marca en París y Lyon.',
          action: 'Lanzar nuevas creatividades, ajustar listas negativas y amplificar testimonios de clientes.',
        },
        {
          id: 'hm3',
          region: 'Latinoamérica',
          sentiment: '81',
          movement: '+5 pts tras bajas exprés',
          priority: 'Mantener presencia ejecutiva en hubs de WhatsApp.',
          action: 'Agendar Q&A semanal en portugués y distribuir cápsulas educativas contra fraude.',
        },
      ],
    },
    forecasts: {
    ...
    evidenceVault: {
      ...
      description:
        'Cada acción del observatorio se sustenta con expedientes listos para audiencias ejecutivas. Descarga los bundles recientes o solicita una versión depurada para el consejo.',
      documents: [
        {
          id: 'ev1',
          name: 'Despiece de fraude en reseñas',
          type: 'Dossier PDF',
          classification: 'Confidencial — founders',
          summary:
            'Capturas con sello de tiempo, oficios de retiro y mapeo del enjambre fraudulento de una barrida reciente en hospitality.',
          cta: 'Abrir el expediente',
          target: 'resources',
        },
        {
          id: 'ev2',
          name: 'Bitácora de escalación en search',
          type: 'Workspace cronológico',
          classification: 'Interno — liderazgo',
          summary:
            'Registro minuto a minuto de un secuestro de keywords con capturas de pujas, aprobaciones y métricas de recuperación.',
          cta: 'Revisar la bitácora',
          target: 'servicesPricing',
        },
        {
          id: 'ev3',
          name: 'Afidávits de suplantación en marketplaces',
          type: 'Archivo seguro',
          classification: 'Reserva legal',
          summary:
            'Afidávits sellados, correos con registradores y conciliaciones de reembolsos de una red de clones en LATAM.',
          cta: 'Solicitar transferencia segura',
          target: 'contact',
        },
      ],
    },
